...
class DbSeeds {
  static Future<void> run(Database db) async {
    ...
    if (seedCheck.isEmpty) {
      ...
      final areas = [
        {
          ...
          'name': 'Corpo e Saúde',
          'description':
              'Treino, mobilidade, alimentação, sono e energia física.',
          'color': 'green',
          'icon': 'fitness_center',
          'sort_order': 1,
        },
        {
          ...
          'description':
              'Estudo, leitura, inglês, programação e clareza mental.',
          'color': 'blue',
          'icon': 'menu_book',
          'sort_order': 2,
        },
        ...
        },
        {
          ...
          'description':
              'Arte, música, vídeo, fotografia, escrita e criatividade.',
          'color': 'pink',
          'icon': 'brush',
          'sort_order': 5,
        },
        {
          ...
          'description':
              'Economia, dívidas, reserva, compras e maturidade financeira.',
          'color': 'amber',
          'icon': 'savings',
          'sort_order': 6,
        },
        {
          ...
          'name': 'Rotina e Ordem',
          'description':
              'Organização, disciplina diária, ambiente e consistência.',
          'color': 'cyan',
          'icon': 'checklist',
          'sort_order': 7,
        },
      ...
      final attributes = [
        {
          ...
          'name': 'Força',
          'description':
              'Capacidade física, resistência muscular e evolução corporal.',
        ...
        },
        {
          ...
          'name': 'Foco',
          'description':
              'Atenção, concentração e permanência em tarefas importantes.',
        ...
        },
        {
          ...
          'name': 'Disciplina',
          'description':
              'Constância, rotina, ordem e execução mesmo sem vontade.',
          'icon': 'verified',
          'sort_order': 7,
        },
        {
          ...
          'name': 'Fé',
          'description':
              'Vida espiritual, oração, propósito e firmeza interior.',
          'icon': 'church',
          'sort_order': 8,
        },
      ];
      ...
      for (final link in links) {
        batch.insert('area_attribute_links', {
          'area_id': link[0],
          'attribute_id': link[1],
          'weight': 1,
        }, conflictAlgorithm: ConflictAlgorithm.ignore);
      ...
      final settings = {
        ...
        'xp_cap_objective_easy': [
          '20',
          'int',
          'XP máximo para objetivo fácil.',
        ],
        'xp_cap_objective_normal': [
          '30',
          'int',
          'XP máximo para objetivo normal.',
        ],
        'xp_cap_objective_medium': [
          '40',
          'int',
          'XP máximo para objetivo médio.',
        ],
        'xp_cap_objective_hard': [
          '60',
          'int',
          'XP máximo para objetivo difícil.',
        ],
        ...
        'project_task_xp_default': [
          '5',
          'int',
          'XP padrão por tarefa de projeto.',
        ],
        'project_task_xp_cap': [
          '10',
          'int',
          'XP máximo por tarefa de projeto.',
        ],
        'project_completion_xp': [
          '150',
          'int',
          'XP padrão ao concluir projeto.',
        ],
  ...
  static Future<void> _runV3Seeds(Database db) async {
    ...
    final difficulties = [
      {
        ...
        'name': 'Normal',
        'description':
            'Modo leve: falhar uma missão não gera penalidade de XP.',
        'penalty_percent': 0,
      ...
      },
      {
        ...
        'name': 'Difícil',
        'description':
            'Modo de compromisso: falhas podem gerar penalidade parcial de XP.',
        'penalty_percent': 50,
        'allow_custom_rewards': 1,
      },
      {
        ...
        'name': 'Hardcore',
        'description':
            'Modo de alta disciplina: falhas podem gerar penalidade total de XP.',
        'penalty_percent': 100,
    ...
    for (final difficulty in difficulties) {
      batch.insert('difficulty_profiles', {
        ...difficulty,
        'is_active': 1,
        'created_at': now,
        'updated_at': now,
    ...
    final settings = {
      'active_difficulty_mode': [
        'normal',
        'string',
        'Modo de dificuldade ativo da campanha atual.',
      ],
      'checkin_daily_coins': [
        '3',
        'int',
        'Coins recebidos no check-in diário.',
      ],
      'checkin_streak_bonus_7': [
        '10',
        'int',
        'Bônus de coins ao completar 7 dias de sequência.',
      ],
      'checkin_streak_bonus_30': [
        '40',
        'int',
        'Bônus de coins ao completar 30 dias de sequência.',
      ],
      ...
      'mission_max_attributes': [
        '3',
        'int',
        'Quantidade máxima de atributos por missão, objetivo ou sessão.',
      ],
      'reminder_checkin_enabled': [
        'true',
        'bool',
        'Ativa lembrete simples de check-in diário.',
      ],
      'reminder_daily_missions_enabled': [
        'true',
        'bool',
        'Ativa lembrete simples de missões diárias.',
      ],
      'session_timer_enabled': [
        'true',
        'bool',
        'Ativa a base do timer real de sessão.',
      ],
    };
    ...
    for (final achievement in achievements) {
      ...
      batch.insert('hero_achievements', {
    ...
    batch.update(
      ...
      {
        'lore':
            'Uma jornada pessoal de disciplina, crescimento e transformação contínua.',
        'main_goal':
            'Construir uma base forte de corpo, mente, fé, finanças e projetos.',
    ...
    final milestones = [
      {
        ...
        'description':
            'Organizar a base da rotina e iniciar a transformação com consistência.',
        'sort_order': 1,
      },
      {
        ...
        'description':
            'Consolidar hábitos físicos, estudo, clareza e energia diária.',
        'sort_order': 2,
      },
      {
        ...
        'description':
            'Avançar em projetos pessoais, carreira e organização financeira.',
        'sort_order': 3,
      },
    ];

    for (final milestone in milestones) {
      batch.insert('campaign_milestones', {
        ...milestone,
    ...
    batch.insert('history_events', {
      ...
      'description':
          'A estrutura técnica da V3 foi criada para campanha, check-in, conquistas, dificuldade e missões compostas.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV35Seeds(Database db) async {
    ...
    final habits = [
      {
        ...
        'title': 'Beber água',
        'description':
            'Construir uma base mínima de hidratação sem exagero inicial.',
        'type': 'build',
        'frequency': 'daily',
        'unit': 'ml',
        'target_value': 1000.0,
      ...
      },
      {
        ...
        'description':
            'Registrar presença espiritual diária, mesmo que seja uma leitura curta.',
        'type': 'build',
        'frequency': 'daily',
        'unit': 'check',
        'target_value': 1.0,
      ...
      },
      {
        ...
        'title': 'Mover o corpo',
        'description':
            'Caminhada, alongamento ou treino leve para sair do sedentarismo.',
        'type': 'build',
        'frequency': 'daily',
        'unit': 'minutes',
        'target_value': 10.0,
      ...
      },
      {
        ...
        'description':
            'Começar reduzindo aos poucos em vez de cortar de uma vez.',
        'type': 'reduce',
        'frequency': 'weekly',
        'unit': 'times',
        'target_value': 1.0,
      ...
      },
      {
        ...
        'description':
            'Mapear doces, salgados, bolachas recheadas e exageros da semana.',
        'type': 'reduce',
        'frequency': 'weekly',
        'unit': 'times',
        'target_value': 1.0,
    ...
    for (final habit in habits) {
      ...
      for (var index = 0; index < attributes.length; index++) {
        batch.insert('item_attribute_links', {
    ...
    batch.insert('history_events', {
      ...
      'description':
          'Hábitos de construção e redução gradual foram adicionados ao Game Life.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV36Seeds(Database db) async {
    ...
    final settings = {
      'health_water_default_ml': [
        '1000',
        'int',
        'Meta inicial diária de água em ml.',
      ],
      'health_water_quick_small_ml': [
        '250',
        'int',
        'Atalho pequeno de registro de água.',
      ],
      'health_water_quick_medium_ml': [
        '500',
        'int',
        'Atalho médio de registro de água.',
      ],
      'health_water_quick_large_ml': [
        '1000',
        'int',
        'Atalho grande de registro de água.',
      ],
      'health_food_limit_default_weekly': [
        '5',
        'int',
        'Limite semanal padrão para rastreadores alimentares.',
      ],
    };
    ...
    final healthHabits = [
      ...
      },
      {
        ...
        'title': 'Controlar doces e ultraprocessados',
        'description':
            'Mapear doces, salgados, bolachas recheadas e exageros da semana sem corte radical.',
        'type': 'reduce',
        'frequency': 'weekly',
        'unit': 'times',
        'target_value': 1.0,
      ...
      },
      {
        ...
        'description':
            'Registrar lanches pesados, salgados e fast-food para reduzir com constância.',
        'type': 'reduce',
        'frequency': 'weekly',
        'unit': 'times',
        'target_value': 1.0,
    ...
    batch.insert('history_events', {
      ...
      'description':
          'Painel de água e alimentação gradual foi conectado aos hábitos de saúde.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV38Seeds(Database db) async {
    ...
    batch.insert('history_events', {
      ...
      'description':
          'O Game Life agora acompanha conquistas automáticas de check-in, missões, hábitos, saúde, foco, objetivos e projetos.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV39Seeds(Database db) async {
    ...
    final achievements = [
      ...
      },
      {
        ...
        'description':
            'Registre seu primeiro dinheiro guardado no Cofre do Reino.',
        'icon': 'account_balance_wallet',
        'category': 'finance',
        'target_value': 1,
        'xp_reward': 8,
    ...
    batch.insert('history_events', {
      ...
      'description':
          'Sistema financeiro básico adicionado para registrar dinheiro real guardado fora do app.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV310Seeds(Database db) async {
    ...
    final items = [
      {
        ...
        'description':
            'Recompensa planejada para jogar sem culpa, com começo e fim definidos.',
        'type': 'reward',
        'coin_cost': 80,
      ...
      },
      {
        ...
        'description':
            'Uma sessão de descanso planejado depois de batalhar de verdade.',
        'type': 'reward',
        'coin_cost': 60,
        'required_money_amount': 0,
        'linked_vault_id': null,
      ...
      },
      {
        ...
        'description':
            'Uma hora livre para lazer leve, sem virar fuga da rotina.',
        'type': 'reward',
        'coin_cost': 40,
        'required_money_amount': 0,
        'linked_vault_id': null,
      ...
      },
      {
        ...
        'description':
            'Compra real planejada. Vincule um cofre com o valor necessário antes de liberar.',
        'type': 'real_purchase',
        'coin_cost': 500,
    ...
    final achievements = [
      ...
      },
      {
        ...
        'description':
            'Libere sua primeira compra real com coins e requisito do cofre cumprido.',
        'icon': 'shopping_bag',
        'category': 'finance',
        'target_value': 1,
        'xp_reward': 15,
    ...
    batch.insert('history_events', {
      ...
      'description':
          'Sistema de recompensas e compras planejadas adicionado ao Game Life.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV311Seeds(Database db) async {
    ...
    batch.update(
      'campaigns',
      {
        ...
        'description':
            'Campanha principal de evolução pessoal com foco em saúde, fé, programação, finanças, projetos e disciplina real.',
        'lore':
    ...
    final milestones = [
      {
        ...
        'title': 'Fundação inicial',
        'description':
            'Construir presença diária, primeiras missões e hábitos básicos sem radicalismo.',
        'lore':
            'O herói sai do modo automático e começa a erguer o acampamento da campanha.',
        'sort_order': 1,
      ...
      },
      {
        ...
        'description':
            'Evoluir água, alimentação, sessões e atributos ligados à saúde física.',
        'lore':
            'A armadura começa a pesar menos quando o corpo volta a acordar.',
        'sort_order': 2,
      ...
      },
      {
        ...
        'description':
            'Transformar sessões, objetivos e tarefas em avanço real nos estudos e no código.',
        'lore':
            'O grimório abre: foco, clareza e prática viram poder acumulado.',
        'sort_order': 3,
      ...
      },
      {
        ...
        'description':
            'Fortalecer presença, constância e o atributo Fé como base interna da jornada.',
        'lore':
            'Sem direção, força vira barulho. Com propósito, até passo pequeno vira marcha.',
        'sort_order': 4,
      ...
      },
      {
        ...
        'title': 'Projetos e responsabilidade',
        'description':
            'Unir tarefas de projeto, cofre, compras planejadas e responsabilidade financeira.',
      ...
      },
      {
        ...
        'description':
            'Amarrar conquistas, atributos, foco, missões e hábitos em consistência visível.',
        'lore':
            'A jornada deixa de ser empolgação inicial e vira identidade praticada.',
        'sort_order': 6,
    ...
    final achievements = [
      {
        ...
        'description':
            'Alcance 25% de progresso médio nos marcos da campanha principal.',
        'icon': 'route',
        'category': 'campaign',
        'target_value': 25,
        'xp_reward': 15,
      ...
      },
      {
        ...
        'description':
            'Alcance 50% de progresso médio nos marcos da campanha principal.',
        'icon': 'flag_circle',
        'category': 'campaign',
        'target_value': 50,
        'xp_reward': 20,
      ...
      },
      {
        ...
        'description':
            'Alcance 90% de progresso médio nos marcos da campanha principal.',
        'icon': 'auto_awesome',
        'category': 'campaign',
        'target_value': 90,
        'xp_reward': 25,
    ...
    batch.insert('history_events', {
      ...
      'description':
          'A Transformação dos 20 aos 25 agora possui marcos automáticos baseados nas ações reais do app.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV312Seeds(Database db) async {
    ...
    batch.insert('history_events', {
      ...
      'description':
          'Onboarding V1 adicionado para preparar herói, dificuldade, foco, água e presets da campanha.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV41Seeds(Database db) async {
    ...
    batch.insert('history_events', {
      ...
      'description':
          'Configuração inicial agora inclui campanha, áreas de vida, atributos sugeridos e Hardcore bloqueado até 7 check-ins.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV43Seeds(Database db) async {
    ...
    await db.insert('history_events', {
      ...
      'description':
          'As áreas da vida agora acumulam XP próprio conforme missões, hábitos, objetivos, sessões e projetos são concluídos.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static Future<void> _runV451Seeds(Database db) async {
    const seedKey = 'seed_v451_campaign_chapters_done';
    final seedCheck = await db.query(
      'app_meta',
      where: 'key = ?',
      whereArgs: [seedKey],
    ...
    final now = DateTime.now().toIso8601String();
    final difficultyRows = await db.query(
      'settings',
      columns: ['value'],
      where: 'key = ?',
    ...
    final storedDifficulty = difficultyRows.isEmpty
        ? 'normal'
        : difficultyRows.first['value']?.toString() ?? 'normal';
    final difficultyMode =
        const {'normal', 'hard', 'hardcore'}.contains(storedDifficulty)
        ? storedDifficulty
        : 'normal';
    final activeCampaignRows = await db.query(
      'campaigns',
      columns: ['id'],
      where: 'is_active = ?',
      whereArgs: [1],
    ...
    batch.insert('campaigns', {
      ...
      'victory_good_percent': 75,
      'victory_excellent_percent': 90,
      'is_active': activeCampaignRows.isEmpty ? 1 : 0,
      'created_at': now,
      'updated_at': now,
    }, conflictAlgorithm: ConflictAlgorithm.ignore);
    final chapters = [
      {
        ...
        'description':
            'Criar presença diária, configurar a campanha e manter os primeiros hábitos sem radicalismo.',
        'lore':
            'Antes da grande jornada, o herói monta acampamento, afia as ferramentas e escolhe o caminho.',
        'start_date': '2026-07-13',
        'end_date': '2026-08-13',
        ...
        'xp_reward': 100,
        'coins_reward': 20,
        'legacy_titles': const ['Fundação inicial'],
        'legacy_descriptions': const [
          'Construir presença diária, primeiras missões e hábitos básicos sem radicalismo.',
          'Organizar a base da rotina e iniciar a transformação com consistência.',
        ],
        'legacy_lore': const [
      ...
      },
      {
        ...
        'description':
            'Sair do sedentarismo, beber mais água, mover o corpo e reduzir excessos aos poucos.',
        'lore':
            'A armadura começa a pesar menos quando o corpo volta a acordar.',
        'start_date': '2026-07-13',
        'end_date': '2027-01-13',
      ...
      },
      {
        ...
        'description':
            'Transformar foco, estudo, leitura e prática de código em avanço real de carreira.',
        'lore':
            'O grimório abre: foco, clareza e prática viram poder acumulado.',
        ...
        'xp_reward': 140,
        'coins_reward': 30,
        'legacy_titles': const ['Mente e programação'],
        'legacy_descriptions': const [
          'Transformar sessões, objetivos e tarefas em avanço real nos estudos e no código.',
        ],
        'legacy_lore': const [
      ...
      },
      {
        ...
        'description':
            'Fortalecer constância espiritual, clareza de direção e responsabilidade interna.',
        'lore':
            'Sem direção, força vira barulho. Com propósito, até passo pequeno vira marcha.',
        ...
        'xp_reward': 120,
        'coins_reward': 20,
        'legacy_titles': const ['Fé e propósito'],
        'legacy_descriptions': const [
          'Fortalecer presença, constância e o atributo Fé como base interna da jornada.',
        ],
        'legacy_lore': const [
      ...
      },
      {
        ...
        'description':
            'Unir projetos, entregas, cofre, compras planejadas e decisões financeiras mais maduras.',
        'lore': 'O reino começa a ter obra, cofre e decisões menos impulsivas.',
        ...
        'xp_reward': 160,
        'coins_reward': 35,
        'legacy_titles': const ['Projetos e responsabilidade'],
        'legacy_descriptions': const [
          'Unir tarefas de projeto, cofre, compras planejadas e responsabilidade financeira.',
          'Avançar em projetos pessoais, carreira e organização financeira.',
        ],
        'legacy_lore': const [
          'O reino começa a ter obra, cofre e decisões menos impulsivas.',
        ],
      },
      {
        'id': 'milestone_campaign_consolidation',
        ...
        'description':
            'Amarrar conquistas, áreas, atributos, foco, finanças e hábitos em uma identidade mais sólida.',
        'lore':
            'A jornada deixa de ser empolgação inicial e vira identidade praticada.',
        ...
        'primary_area_id': 'routine_order',
        'secondary_area_ids':
            'body_health,mind_knowledge,finance_responsibility',
        'automation_key': 'campaign_consolidation',
        'sort_order': 6,
        'xp_reward': 200,
        'coins_reward': 50,
        'legacy_titles': const ['Consolidação da campanha'],
        'legacy_descriptions': const [
          'Amarrar conquistas, atributos, foco, missões e hábitos em consistência visível.',
        ],
        'legacy_lore': const [
    ...
    for (final chapter in chapters) {
      ...
      _setSeedValueIfDifferent(
        updates,
        existing,
        key: 'campaign_id',
        value: 'transformation_20_25',
      );
      _setSeedValueIfDifferent(
        updates,
        existing,
      ...
      _setSeedValueIfDifferent(
        ...
        existing,
        key: 'automation_key',
        value: chapter['automation_key']!,
      );
      _setSeedValueIfDifferent(
        updates,
        existing,
        key: 'auto_progress_enabled',
        value: 1,
      );
      _setSeedValueIfDifferent(
        updates,
      ...
      _setCanonicalChapterText(
        updates,
        existing,
        key: 'title',
        canonical: chapter['title']! as String,
        legacyValues: chapter['legacy_titles']! as List<String>,
      );
      _setCanonicalChapterText(
        updates,
        existing,
        key: 'description',
        canonical: chapter['description']! as String,
        legacyValues: chapter['legacy_descriptions']! as List<String>,
      );
      _setCanonicalChapterText(
        updates,
        existing,
        key: 'lore',
        canonical: chapter['lore']! as String,
        legacyValues: chapter['legacy_lore']! as List<String>,
      );

      final existingTarget = _seedText(existing['target_date']);
      final existingEnd = _seedText(existing['end_date']);
      final resolvedEnd = existingEnd.isNotEmpty
          ? existingEnd
          : existingTarget.isNotEmpty
          ? existingTarget
          : chapter['end_date']! as String;

      _setSeedValueIfBlank(
        updates,
        existing,
        key: 'start_date',
        value: chapter['start_date']! as String,
      );
      _setSeedValueIfBlank(
        updates,
        existing,
      ...
      _setSeedValueIfBlank(
        ...
        existing,
        key: 'primary_area_id',
        value: chapter['primary_area_id']! as String,
      );
      _setSeedValueIfBlank(
        updates,
        existing,
        key: 'secondary_area_ids',
        value: chapter['secondary_area_ids']! as String,
      );
    ...
    batch.insert('settings', {
      ...
      'value_type': 'text',
      'description':
          'Define que a campanha usa linguagem narrativa de capítulos em vez de marcos.',
      'updated_at': now,
    }, conflictAlgorithm: ConflictAlgorithm.ignore);

    batch.insert('history_events', {
      'id': 'history_v451_campaign_chapters',
      'title': 'Campanha organizada em capítulos',
      'description':
          'Os marcos da campanha passaram a ser tratados como capítulos com período, área principal e áreas secundárias.',
      'type': 'system',
      'xp_delta': 0,
      'coins_delta': 0,
      'occurred_at': now,
  ...
  static void _setCanonicalChapterText(
    ...
    final current = _seedText(existing[key]);
    if (current.isEmpty || legacyValues.contains(current)) {
      if (current != canonical) updates[key] = canonical;
    }
  }

  static void _setSeedValueIfBlank(
    Map<String, Object?> updates,
    Map<String, Object?> existing, {
    required String key,
    required Object value,
  }) {
    if (_seedText(existing[key]).isEmpty) updates[key] = value;
  }

  static void _setSeedValueIfDifferent(
    Map<String, Object?> updates,
    Map<String, Object?> existing, {
    required String key,
    required Object value,
  }) {
    if (_seedText(existing[key]) != _seedText(value)) updates[key] = value;
  }

  static String _seedText(Object? value) => value?.toString().trim() ?? '';
}
